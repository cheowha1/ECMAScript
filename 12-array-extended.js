...
function testReduce() {
    ...
    let sum = source.reduce((acc, value, index, arr) => {
        ...
        return acc + value; // -> 다음번 클백의 acc로 전달
    }, 0);
...
function testDataPipeline() {
    console.log("=====map, filter, sort, reduce를 이용한 데이터 파이프 라인");
    ...
    console.log("청점240이상 학생들의 평균:", avgTotalSum);
}   
// testDataPipeline();
